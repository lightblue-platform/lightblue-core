...
public class MetadataJsonSchemaInvalidTest extends AbstractJsonSchemaTest {
    @Parameterized.Parameters(name = "resource={0}")
    public static Collection<Object[]> data() throws IOException {
        List<Object[]> output = new ArrayList<>();
        try (InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream("junit-files-metadata-json-schema-test-invalid.log");
    ...
    public MetadataJsonSchemaInvalidTest(String resourceName) {
    ...
    public void validateMetadata() throws IOException, ProcessingException {
        runInvalidJsonTest("json-schema/metadata/metadata.json", resourceName);
    }
}
