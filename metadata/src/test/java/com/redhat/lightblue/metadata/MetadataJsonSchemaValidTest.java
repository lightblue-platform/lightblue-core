...
public class MetadataJsonSchemaValidTest extends AbstractJsonSchemaTest {
    @Parameterized.Parameters(name = "resource={0}")
    public static Collection<Object[]> data() throws IOException {
        List<Object[]> output = new ArrayList<>();
        try (InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream("junit-files-metadata-json-schema-test-valid.log");
    ...
    public MetadataJsonSchemaValidTest(String resourceName) {
    ...
    public void validateMetadata() throws IOException, ProcessingException {
        runValidJsonTest("json-schema/metadata/metadata.json", resourceName);
    }
}
