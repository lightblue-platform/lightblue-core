...
public class HookJsonSchemaValidTest extends AbstractJsonSchemaTest {
    ...
    public static Collection<Object[]> data() throws IOException {
        ...
        try (InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream("junit-files-hook-json-schema-test-valid.log");
    ...
    public HookJsonSchemaValidTest(String resourceName) {
    ...
    public void validateMetadata() throws IOException, ProcessingException {
        runValidJsonTest("json-schema/metadata/hook.json", resourceName);
    }
}
