...
public interface Metadata extends Serializable {
    ...
    /**
     * Get all dependencies for the given entity using the given version. If
     * entity name is not specified all entity dependencies are processed. If no
     * entity version is specified default version for the entity is used, lack
     * of default version is treated as a data error.
     *
    ...
    /**
     * Get all entity and field access for the given entity using the given
     * version. If entity name is not specified all entities are processed. If
     * no entity version is specified default version for the entity is used,
     * lack of default version is treated as a data error.
     *
     * @return Response with array of Map<String, MetadataAccess> data, where
     * key is the entity name
     */
    Response getAccess(String entityName, String version);

    /**
     * Returns a particular version of the entity metadata if a version is
     * specified. Otherwise, it returns the default version
     */
     ...
     *
     * @param statuses If empty, all entity names are returned. Otherwise, only
     * those entities that have schema with the given statuses are returned
     */
