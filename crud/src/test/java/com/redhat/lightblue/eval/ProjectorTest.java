...
public class ProjectorTest extends AbstractJsonNodeTest {
	...
	public void fieldProjectorTest_arr_range_projection() throws Exception {
		Projection p = EvalTestContext
				.projectionFromJson("{'field':'field7','range':[1,2],'projection':{'field':'elemf3'}}");
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
		Assert.assertNull(pdoc.get(new Path("field1")));
		Assert.assertNull(pdoc.get(new Path("field2")));
	...
	public void fieldProjectorTest_arr_query_projection() throws Exception {
		Projection p = EvalTestContext.projectionFromJson(
				"{'field':'field7','match':{'field':'elemf3','op':'>','rvalue':4},'projection':{'field':'*'}}");
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
		Assert.assertNull(pdoc.get(new Path("field1")));
		Assert.assertNull(pdoc.get(new Path("field2")));
	...
	public void fieldProjectorTest_arr_star_query() throws Exception {
		Projection p = EvalTestContext.projectionFromJson(
				"{'field':'field12.nf1.nnf1.*.nnnf1.arr','match':{'field':'id','op':'=','rvalue':12}}}");
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
	...
	public void fieldProjectorTest_arr_query_sort_projection() throws Exception {
		Projection p = EvalTestContext.projectionFromJson(
				"{'field':'field7','match':{'field':'elemf3','op':'>=','rvalue':4},'project':{'field':'*'}, 'sort': { 'elemf2':'$desc'}}");
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
		Assert.assertNull(pdoc.get(new Path("field1")));
		Assert.assertNull(pdoc.get(new Path("field2")));
	...
	public void fieldProjectorTest_arr_query_sort() throws Exception {
		Projection p = EvalTestContext.projectionFromJson(
				"{'field':'field7','match':{'field':'elemf3','op':'>=','rvalue':4},'projection':{'field':'*'}, 'sort': { 'elemf2':'$desc'}}");
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
		Assert.assertNull(pdoc.get(new Path("field1")));
		Assert.assertNull(pdoc.get(new Path("field2")));
	...
	public void fieldProjectorTest_arr_query_or() throws Exception {
		Projection p = EvalTestContext.projectionFromJson(
				"{'field':'field7','match':{'$or':[{'field':'elemf3','op':'>','rvalue':4},{'field':'elemf3','op':'>','rvalue':5}]},'project':{'field':'*'}}");
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
		Assert.assertNull(pdoc.get(new Path("field1")));
		Assert.assertNull(pdoc.get(new Path("field2")));
	...
	public void fieldProjectorTest_arr_query_or_projection() throws Exception {
		Projection p = EvalTestContext.projectionFromJson(
				"{'field':'field7','match':{'$or':[{'field':'elemf3','op':'>','rvalue':4},{'field':'elemf3','op':'>','rvalue':5}]},'projection':{'field':'*'}}");
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
		Assert.assertNull(pdoc.get(new Path("field1")));
		Assert.assertNull(pdoc.get(new Path("field2")));
	...
	public void fieldProjectorTest_include_then_exclude() throws Exception {
		Projection p = EvalTestContext
				.projectionFromJson("[{'field':'field6.*'},{'field':'field6.nf3','include':false}]");
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
	...
	public void fieldProjectorTest_includeArrayExcludeFields() throws Exception {
		Projection p = EvalTestContext.projectionFromJson(
				"{'field':'field7','include':true,'match':{'field':'elemf3','op':'>','rvalue':4},'project':[{'field':'*'},{'field':'elemf1','include':false}]}");
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
		Assert.assertNull(pdoc.get(new Path("field1")));
		Assert.assertNull(pdoc.get(new Path("field2")));
	...
	public void fieldProjectorTest_includeArrayExcludeFields_projection() throws Exception {
		Projection p = EvalTestContext.projectionFromJson(
				"{'field':'field7','include':true,'match':{'field':'elemf3','op':'>','rvalue':4},'projection':[{'field':'*'},{'field':'elemf1','include':false}]}");
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
		Assert.assertNull(pdoc.get(new Path("field1")));
		Assert.assertNull(pdoc.get(new Path("field2")));
	...
	public void fieldProjectorTest_includeArrayExcludeFields2() throws Exception {
		Projection p = EvalTestContext
				.projectionFromJson("[{'field':'*'},{'field':'field7.*.*'},{'field':'field7.*.elemf1','include':0}]");
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
	...
	public void fieldProjectorTest_nestedArray() throws Exception {
		Projection p = EvalTestContext
				.projectionFromJson("{'field':'field11', 'include':1, 'match':{ 'field':'f1','op':'=','rfield':'f1'}, "
		...
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
		Assert.assertEquals(Projection.Inclusion.explicit_inclusion,
				p.getFieldInclusion(new Path("field11.*.arr.*.x1")));
		Assert.assertEquals(Projection.Inclusion.explicit_inclusion,
				p.getFieldInclusion(new Path("field11.0.arr.0.x2")));
	...
	public void emptyArray() throws Exception {
		Projection p = EvalTestContext.projectionFromJson(
				"[{'field':'*','recursive':1},{'field':'field11', 'include':1, 'match':{ 'field':'f1','op':'=','rvalue':100}}]");
		Projector projector = Projector.getInstance(p, md);
		JsonDoc pdoc = projector.project(jsonDoc, JSON_NODE_FACTORY);
		System.out.println(pdoc);
