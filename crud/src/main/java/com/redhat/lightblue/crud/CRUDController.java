...
public interface CRUDController {
     ...
     *
     * The resolver must provide access to the correct versions of
     * metadata used to insert/update all the documents. There is no
     * limitation on the list of documents other than that they all
     * have to belong to this particular back-end. Documents can
     * belong to different data stores of the same back-end. If a
     * document has nonnull _id field, the document is updated in the
     * db. Otherwise, if upsert is true, the document is updated.  If
     * projection is non-null, the data must be projected and
     * returned, otherwise, no data is returned.
     */
     ...
     * @param from starting index in the result set. Can be
     * null. Meaninguful only if a sort is given. Starts from 0.
     * @param to end index in the result set. Starts from 0, and
     * inclusive. Can be null.
     */
